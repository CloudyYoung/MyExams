...
?>
	...
	<head>
		...
		<link rel="stylesheet" href="layui-v2.2.6/css/layui_MyExams_adapt.css?<?php echo $version ?>">
	...
	-->
		...
		<div id="course-finish" style="display: none;">
			...
			<script type="text/javascript" src="function.js?<?php echo $version ?>"></script>
			<script src="js/dest/layui.js?<?php echo $version ?>"></script>
			<script src="js/dest/layui.all.js?<?php echo $version ?>"></script>
			<script src="js/jquery-3.2.1.min.js?<?php echo $version ?>"></script>
			<script src="js/like.js?<?php echo $version ?>"></script>
			<script src="js/mo.min.js?<?php echo $version ?>"></script>
			...
			<script type="text/javascript">
				...
				?>
					...
					layer.msg('This project is archived and no longer <br>maintained. <br>Thank you for being supportive <br>in Year 2017 and 2018. <br><br>See you in future.<br> - Cloudy Young');
				...
				function getExamFullName() {
					...
					getPageContent('request.php', {
						func: 'getExamFullName'
					}, function(res) {
		...
		<div class="header">
			<ul>
				<a href="javascript: " style="overflow: hidden;">
					...
					<li class="header-ul-li" style="text-align: right;">
						<a href="javascript: ">
							<p id="user"><i class="fa fa-user-circle-o"></i> <?php echo $_REQUEST['sn'] ?></p>
						</a>
					</li>
				</a>
	...
	-->
		...
		<script>
			...
			function getStudentNumber() {
				...
				post('request.php', {
					func: 'saveStudentNumber',
					studentNumber: "<?php echo $_REQUEST['sn'] ?>",
					method: "user"
				}, function(res) {
					if (res.code == 1) {
