		...
		new Animocon(el14, {
			...
			tweens : [
				...
				new mojs.Transit({
					...
					strokeWidth: {35:0},
					opacity: 0.2,
					x: (document.documentElement.clientWidth / 2) - 75,
					y: '21%',
					isRunLess: true,
			...
			onCheck : function() {
				...
				el14.style.color = '#ff5050';
				
				post("request.php", {func: "like"}, function(res){
					
					
					if(res.code == 0){
						
						el14counter.innerHTML = res.like;
			...
			onUnCheck : function() {
				...
				el14counter.innerHTML = (Number(el14counter.innerHTML.replace(",", "")) - 1).toLocaleString();
